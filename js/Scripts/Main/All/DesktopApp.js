(async function() {
  var leftpanel = await document.waitSelector("#navigation > div > div.simplebar-wrapper > div.simplebar-mask > div > div > div > ul");
  ...
  newbutton.addEventListener("click", ()=>{eval(`function openDesktopUniversalApp() {
