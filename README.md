...
Roblokis is available on Chrome Web Store and Mozilla Add-ons, please avoid any copies that aren't mine.  
...
## Installation
If you want a static copy of the extension, you can read a small tutorial in `installation.md` file