...
page.start = async function() {
    ...
    document.$watchLoop(".rk-button", (e) => {
        if(e.dataset.listening != null) return;
        e.dataset.listening = "true";
    ...
    document.$watchLoop(".rk-textfield", (e) => {
        if(e.dataset.listening != null) return;
        e.dataset.listening = "true";
    	...
    	<div id="rkpage" style="margin: 0 0 0 1%;width: 60%;">
    		<div class="main">
    			<div class="tabcontent about">
					...
					<div class="section-content">
					   ...
					   <div>
					      ...
					      <a href="https://discord.gg/esMtQ9Q3FF">https://discord.gg/esMtQ9Q3FF</a><br><br>
					...
					<div class="section-content">
					   ...
					   <table class="table table-striped features-table" style="border-radius: 12px;">
					      ...
					      <tbody>
					         ...
					         <tr>
					            <td></td>
					            <td class="text-lead">Old Roblox Status</td>
					            <td class="text-description">On any profile page, it will show you the old players status by roblox.</td>
					         </tr>
					         <tr>
					            <td></td>
					            <td class="text-lead">Cencel Friend Request</td>
    			...
    			<div class="tabcontent all">
					...
					<div class="section-content">
					   <span class="text-lead" data-translate="sectionCRT">Custom Robux Text:</span>
					   <input class="rk-textfield form-control input-field" placeholder="Leave empty for default" data-file="CustomRobux">
					   <div class="rbx-divider" style="margin: 12px;"></div>
					   <span class="text-description" data-translate="sectionCRT1">This replaces the top right robux text on all roblox sites.</span>
					</div>

					<div class="section-content">
					   <span class="text-lead" data-translate="sectionCNT">Custom Name Text:</span>
					   <input class="rk-textfield form-control input-field" placeholder="Leave empty for default" data-file="CustomName">
					   <div class="rbx-divider" style="margin: 12px;"></div>
					   <span class="text-description" data-translate="sectionCNT1">This replaces the top right username text on all roblox sites.</span>
					</div>

					<div class="section-content">
					   <span class="text-lead" data-translate="sectionLSite">Roblox site languages.</span>
					   <span class="rk-button receiver-destination-type-toggle off" data-file="SiteLanguage">
					      <span class="toggle-flip"></span>
					      <span class="toggle-on"></span>
					      <span class="toggle-off"></span>
					   </span>
					   <div class="rbx-divider" style="margin: 12px;"></div>
					   <span class="text-description" data-translate="sectionLSite1">Limits Roblokis Language to Roblox Site Language.</span>
					</div>

					<div class="section-content">
					   <span class="text-lead" data-translate="sectionQJB">Quick Join Button.</span>
					   <span class="rk-button receiver-destination-type-toggle on" data-file="QuickGameJoin">
					      <span class="toggle-flip"></span>
					      <span class="toggle-on"></span>
					      <span class="toggle-off"></span>
					   </span>
					   <div class="rbx-divider" style="margin: 12px;"></div>
					   <span class="text-description" data-translate="sectionQJB1">Adds a join button under every game on hame and discover pages.</span>
					</div>

					<div class="section-content">
					   <span class="text-lead" data-translate="sectionDApp">Desktop App.</span>
					   <span class="rk-button receiver-destination-type-toggle on" data-file="DesktopApp">
					      <span class="toggle-flip"></span>
					      <span class="toggle-on"></span>
					      <span class="toggle-off"></span>
					   </span>
					   <div class="rbx-divider" style="margin: 12px;"></div>
					   <span class="text-description" data-translate="sectionDApp1">Enables the desktop app design by Roblox.</span>
					</div>
    			</div>
    			<div class="tabcontent changelog">
					...
					<div class="section-content">
					   <h4>Roblokis V3.1.2.1</h4>
					   <div>
					      Rebuild Roblokis from zero
					   </div><br>
    			...
    			<div class="tabcontent designer">
					...
					<div id="rk-themesection">
					   ...
					   <div class="section-content">
					      <span class="text-lead" data-translate="sectionUThemes">Use Themes.</span>
					      <span class="rk-button receiver-destination-type-toggle on" data-file="UseThemes">
					         <span class="toggle-flip"></span>
					         <span class="toggle-on"></span>
					         <span class="toggle-off"></span>
					      </span>
					      <div class="rbx-divider" style="margin: 12px;"></div>
					      <span class="text-description" data-translate="sectionUThemes1">Disabling this will disable Styles and Themes!</span>
					   </div>
					   ...
					   <div class="section-content">
					      <span class="text-lead" data-translate="sectionExtraS">Extra Shadows.</span>
					      <span class="rk-button receiver-destination-type-toggle off" data-file="ExtraShadows">
					         <span class="toggle-flip"></span>
					         <span class="toggle-on"></span>
					         <span class="toggle-off"></span>
					      </span>
					      <div class="rbx-divider" style="margin: 12px;"></div>
					      <span class="text-description" data-translate="sectionExtraS1">Adds a shadow effect under or around some elements.</span>
					   </div>
					   ...
					   <div class="rk-popup" style="width: 85%;height: 100%;padding: calc(4% + 10px) calc(3% + 10px);overflow: auto;flex-direction: column;justify-content: flex-start;">
					      ...
					      <div>
					         ...
					         <div style="display: none;">
					            <loadcode run='
					               showthelem = function(elem, click) {
					                  if(click.target.tagName != "LOADCODE") {
					                     document.$triggerCustom("openedit", elem.firstElementChild)
					                     elem.firstElementChild.style.display = "flex";
					                  }
					               }

					               hidethelem = function(elem, click) {
					                  if(click.target == elem) {
					                     document.$triggerCustom("closeedit", elem.parentElement)
					               ...
					               CreateStyleformto = function(efrom, eto) {
					                  ...
					                  function run() {
					                     ...
					                     for (var stnnum = 0; stnnum < settingelements.length; stnnum++) {
					                        ...
					                        stringplace = stringplace.replace("null", JSON.stringify(GetTypeValue(input.dataset.type, input.value, newplace)));
					            ...
					            <savecode code="editbackground">
					               ...
					               <div class="section-content">
					                  ...
					                  <div class="text-lead" style="display: flex;align-items: center;justify-content: space-between;"><span style="min-width: fit-content;margin-right: 5px;" data-translate="themeColor">Color:</span><input type="color" value="#232527" data-location="\${loc}.color" data-type="color" class="form-control input-field"></div>

					                  <div class="text-lead" style="display: flex;align-items: center;justify-content: space-between;"><span style="min-width: fit-content;margin-right: 5px;" data-translate="themeAlpha">Alpha:</span><input type="range" value="100" step="10" data-location="\${loc}.color" data-type="color-alpha" class="form-control input-field"></div>


					                  <div class="rbx-divider" style="margin: 12px;"></div>


					                  <div class="text-lead" style="display: flex;align-items: center;justify-content: space-between;"><span style="min-width: fit-content;margin-right: 5px;" data-translate="themeLink">Link:</span><input type="url" value="" data-location="\${loc}.image.link" data-type="value" class="form-control input-field"></div>
					            ...
					            <savecode code="editsectioncheckbox">
					            ...
					            <savecode code="editelement">

					               //onclick="hidethelem(this,event)" class="rk-popup-holder" style="z-index: 999;"
					               element.addEventListener("click", function(e) {hidethelem(element,e)})
					               element.classList.add("rk-popup-holder");
					               element.style.zIndex = "999";</savecode>
					            <savecode code="loadedits">
					            ...
					            <div style="background-color: #fff;transition: all 400ms;position: relative;">
					               <loadcode run='
					                  ...
					                  function editwindow() {
					                     ...
					                     parent.style.width = \`calc(\${sizes[0]}px * var(--editor-size-percent))\`;
					                     parent.style.height = \`calc(\${sizes[1]}px * var(--editor-size-percent))\`;
					                  }
					               ...
					               <div class="designer-section" style="transition: all 400ms;position: relative;overflow: hidden;">
					                  <loadcode run='
					                     ...
					                     function editwindow() {
					                        ...
					                        parent.style.width = \`calc(\${sizes[0]}px * var(--editor-size-percent) * 0.5)\`;
					                        parent.style.height = \`fit-content\`;
					                     }
					               ...
					               <div class="designer-section" style="transition: all 400ms;position: relative;overflow: hidden;">
					                  <loadcode run='
					                     ...
					                     function editwindow() {
					                        ...
					                        parent.style.width = \`calc(\${sizes[0]}px * var(--editor-size-percent) * 0.4)\`;
					                        parent.style.height = \`fit-content\`;
					                     }
					                  ...
					                  <div class="recreate-servers mainpreview selectable dark" data-type="server designer-btn showthelem">
					                     <loadcode code="editelement">
					                        ...
					                        <div class="designer-section" style="margin-bottom: 20px;transition: all 400ms;position: relative;overflow: hidden;min-width: 240px;">
					                           ...
					                           <div class="recreate-servers selectable dark designer-btn showthelem">
					                              <loadcode code="editelement">
					                                 ...
					                                 <div class="section-left rbx-private-server-details group designer-section" style="float: none;width: auto;border-width: initial;border-style: none;border-color: initial;border-image: initial;padding: 10px;border-radius: 20px;margin-bottom: 20px;min-width: 220px; designer-btn showthelem">
					                                    <loadcode code="editelement">
					                        ...
					                        <div class="designer-section" style="margin-bottom: 20px;transition: all 400ms;position: relative;overflow: hidden;min-width: 240px;">
					                           ...
					                           <div class="recreate-servers selectable dark designer-btn showthelem">
					                              <loadcode code="editelement">
					                                 ...
					                                 <div class="rbx-private-server-details group designer-section" style="float: none;width: auto;border-width: initial;border-style: none;border-color: initial;border-image: initial;padding: 10px;border-radius: 20px;margin-bottom: 20px;min-width: 220px; designer-btn showthelem">
					                                    <loadcode code="editelement">
    		...
    		<div class="gamepage">
    			<div class="tabcontent badges">
					...
					<div class="section-content">
					   <span class="text-lead" data-translate="sectionCBV">New Badges Look & Load all.</span>
					   <span class="rk-button receiver-destination-type-toggle on" data-file="Badges">
					      <span class="toggle-flip"></span>
					      <span class="toggle-on"></span>
					      <span class="toggle-off"></span>
					   </span>
					   <div class="rbx-divider" style="margin: 12px;"></div>
					   <span class="text-description" data-translate="sectionCBV1">Shows the new Style design by Ameer! loads first 100 badges automatically.</span>
					</div>

					<div class="section-content">
					   <span class="text-lead" data-translate="sectionCBH">Show Hidden Badges.</span>
					   <span class="rk-button receiver-destination-type-toggle on" data-file="BadgesHidden">
					      <span class="toggle-flip"></span>
					      <span class="toggle-on"></span>
					      <span class="toggle-off"></span>
					   </span>
					   <div class="rbx-divider" style="margin: 12px;"></div>
					   <span class="text-description" data-translate="sectionCBH1">Shows the Hidden/Disabled Badges!</span>
					</div>
    			</div>
    			<div class="tabcontent servers">
					...
					<div class="section-content">
					   <span class="text-lead" data-translate="sectionMPN">Maximum Players Number.</span>
					   <span class="rk-button receiver-destination-type-toggle on" data-file="ShowMaxPlayers">
					      <span class="toggle-flip"></span>
					      <span class="toggle-on"></span>
					      <span class="toggle-off"></span>
					   </span>
					   <div class="rbx-divider" style="margin: 12px;"></div>
					   <span class="text-description" data-translate="sectionMPN1">Shows Maximum players number next to the available players number.</span>
					</div>
					...
					<div class="serversselector" style="margin: 6px;border-radius: 20px;border: 1px solid grey;padding: 6px 12px;display: flex;align-items: center;">
					   ...
					   <select selected="" style="width: 100%;background-color: rgb(128 128 128 / 40%);padding: 6px;border-radius: 10px;border-right: 1px solid;border-bottom: 1px solid;">
					      ...
					      <option value="filteredservers" data-translate="serversFiltered">Filtered Servers</option>
					   </select>
					</div>
					<div id="pageloadplace">
						<div class="serversection privateservers">
							...
							<div class="section-content" hidden>
							   ...
							   <span class="rk-button btn-toggle receiver-destination-type-toggle on" data-file="PrivateServersLink"><span class="toggle-flip"></span><span class="toggle-on"></span><span class="toggle-off"></span></span>
							   <div class="rbx-divider" style="margin: 12px;"></div>
							...
							<div class="section-content">
							   <span class="text-lead" data-translate="sectionALM">Automatic Load More.</span>
							   <span class="rk-button btn-toggle receiver-destination-type-toggle on" data-file="ShowPrivateServers"><span class="toggle-flip"></span><span class="toggle-on"></span><span class="toggle-off"></span></span>
							   <div class="rbx-divider" style="margin: 12px;"></div>
							   <span class="text-description" data-translate="sectionALM1">Automatically clicks load more then the servers refresh.</span>
							</div>

							<div class="section-content">
							   <span class="text-lead" data-translate="sectionASO">Available Servers Only.</span>
							   <span class="rk-button btn-toggle receiver-destination-type-toggle on" data-file="AvailPrivateServers"><span class="toggle-flip"></span><span class="toggle-on"></span><span class="toggle-off"></span></span>
							   <div class="rbx-divider" style="margin: 12px;"></div>
							   <span class="text-description" data-translate="sectionASO1">Removes all unavailable servers or all servers without a join button.</span>
							</div>
						</div>
						<div class="serversection friendservers">
							...
							<div class="section-content">
							   ...
							   <span class="rk-button btn-toggle receiver-destination-type-toggle on" data-file="FriendsServersText"><span class="toggle-flip"></span><span class="toggle-on"></span><span class="toggle-off"></span></span>
							   <div class="rbx-divider" style="margin: 12px;"></div>
							...
							<div class="section-content" hidden>
							   <span class="text-lead" data-translate="sectionSLB">Server Link Button.</span>
							   <span class="rk-button btn-toggle receiver-destination-type-toggle on" data-file="FriendsServersLink"><span class="toggle-flip"></span><span class="toggle-on"></span><span class="toggle-off"></span></span>
							   <div class="rbx-divider" style="margin: 12px;"></div>
							   <span class="text-description" data-translate="sectionSLB1">Shows a link button next to the join button and gives server's join link.</span>
						...
						<div class="serversection smallservers">
							...
							<div class="section-content">
							   <span class="text-lead" data-translate="SectionSSS">Small Servers Section.</span>
							   <span class="rk-button btn-toggle receiver-destination-type-toggle on" data-file="SmallServer"><span class="toggle-flip"></span><span class="toggle-on"></span><span class="toggle-off"></span></span>
							   <div class="rbx-divider" style="margin: 12px;"></div>
							   <span class="text-description" data-translate="SectionSSS1">A new section show servers with few players.</span>
							</div>

							<div class="section-content">
							   <span class="text-lead" data-translate="sectionSLB">Servers Link Button.</span>
							   <span class="rk-button btn-toggle receiver-destination-type-toggle on" data-file="SmallServerLink"><span class="toggle-flip"></span><span class="toggle-on"></span><span class="toggle-off"></span></span>
							   <div class="rbx-divider" style="margin: 12px;"></div>
							   <span class="text-description" data-translate="sectionSLB1">Shows a link button next to the join button and gives server's join link.</span>
							   <div class="text-description" style="color: red;" data-translate="sectionSLink">NOTE: Sharing the link won't work unless the person also have this extension!</div>
							</div>
						...
						<div class="serversection publicservers">
							...
							<div class="section-content" hidden>
							   <span class="text-lead" data-translate="sectionSLB">Server Link Button.</span>
							   <span class="rk-button btn-toggle receiver-destination-type-toggle on" data-file="PublicServersLink"><span class="toggle-flip"></span><span class="toggle-on"></span><span class="toggle-off"></span></span>
							   <div class="rbx-divider" style="margin: 12px;"></div>
							   <span class="text-description" data-translate="sectionSLB1">Shows a link button next to the join button and gives server's join link.</span>
							   <div class="text-description" style="color: red;" data-translate="sectionSLink">NOTE: Sharing the link won't work unless the person also have this extension!</div>
							</div>
							...
							<div class="section-content">
							   ...
							   <span class="rk-button btn-toggle receiver-destination-type-toggle on" data-file="PageNav"><span class="toggle-flip"></span><span class="toggle-on"></span><span class="toggle-off"></span></span>
							   <div class="rbx-divider" style="margin: 12px;"></div>
						...
						<div class="serversection filteredservers">
							...
							<div class="section-content">
							   ...
							   <span class="rk-button btn-toggle receiver-destination-type-toggle off" data-file="FilteredServer">
							      <span class="toggle-flip"></span>
							      <span class="toggle-on"></span>
							      <span class="toggle-off"></span>
							   </span>
							...
							<div class="section-content">
							   <span class="text-lead" data-translate="sectionSPN">Server Page Nav.</span>
							   <span class="rk-button btn-toggle receiver-destination-type-toggle on" data-file="FilteredPageNav">
							      <span class="toggle-flip"></span>
							      <span class="toggle-on"></span>
							      <span class="toggle-off"></span>
							   </span>
							...
							<div class="section-content">
							   <span class="text-lead" data-translate="sectionSLB">Servers Link Button.</span>
							   <span class="rk-button btn-toggle receiver-destination-type-toggle on" data-file="FilteredServerLink">
							      <span class="toggle-flip"></span>
							      <span class="toggle-on"></span>
							      <span class="toggle-off"></span>
							   </span>
    		...
    		<div class="profiles">
    			<div class="tabcontent profilepage">
					...
					<div class="section-content">
					   <span class="text-lead" data-translate="sectionLS">Last Status.</span><span class="rk-button btn-toggle receiver-destination-type-toggle on" data-file="LastStats"><span class="toggle-flip"></span><span class="toggle-on"></span><span class="toggle-off"></span></span>
					   <div class="rbx-divider" style="margin: 12px;"></div>
					   <span class="text-description" data-translate="sectionLS1">Shows Player's Last Activity on his Profile Page.</span>
					</div>
					<div class="section-content">
					   <span class="text-lead" data-translate="sectionCP">Cancel Pending.</span><span class="rk-button btn-toggle receiver-destination-type-toggle on" data-file="CancelPending"><span class="toggle-flip"></span><span class="toggle-on"></span><span class="toggle-off"></span></span>
					   <div class="rbx-divider" style="margin: 12px;"></div>
					   <span class="text-description" data-translate="sectionCP1">Shows a "Cancel Pending" Button instead of "Pending".</span>
					</div>
    			</div>
    			<div class="tabcontent friendspage">
					...
					<div class="section-content">
					   <span class="text-lead" data-translate="sectionQRB">Quick Remove Button.</span><span class="rk-button btn-toggle receiver-destination-type-toggle on" data-file="QuickRemove"><span class="toggle-flip"></span><span class="toggle-on"></span><span class="toggle-off"></span></span>
					   <div class="rbx-divider" style="margin: 12px;"></div>
					   <span class="text-description" data-translate="sectionQRB1">Small button to remove friends faster.</span>
					   <div style="color: red;" class="text-description" data-translate="sectionQRB2">NOTE: You have to double click the button to remove friends!</div>
					</div>
    			</div>
    		</div>
    	</div>
