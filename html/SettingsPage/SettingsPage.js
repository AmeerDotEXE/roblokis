...
//in adding menu you can add options if in designer tab
//you can add both options (limited) and edits in element tab
let designerOptions = []; //list of editable elements
